    ...
    <div className="home">
      ...
      <section style={{ backgroundColor: "#002b5b" }}>
          ...
          >
            <div className="col-md-6 offset-md-3 text-center p-5 my-5" style={{backgroundColor: "rgba(1, 2, 2, 0.4)", borderRadius:"22px"}}>
              ...
              >
                ...
                ultimate game that turns learning Data Structures and Algorithms
                (DSA) into an immersive and enjoyable experience!
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="container my-5">
          <h1
            class="display-5 fw-bold lh-1 mb-3 text-center"
            style={{ color: "white" }}
          >
            About Us
          </h1>
          <div
            class="row p-5 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 text-center"
          ...
          >
            <div class=" p-5 p-lg-5 pt-lg-3">
              <p class="lead">
                Embark on an exciting educational adventure with DSA Quest, the
                ultimate game that turns learning Data Structures and Algorithms
                (DSA) into an immersive and enjoyable experience!. Dive into a
                captivating virtual world where you'll unravel the secrets of
                DSA through thrilling challenges, mind-bending puzzles, and
                strategic gameplay.
              </p>
              <br></br>
              <br></br>
        ...
        <div class="container my-5 border-top">
          ...
          <div
            class="row p-5 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 mx-5"
            style={{ backgroundColor: "#002b5b", color: "white" }}
          >
            <div class="col-lg-7 p-5 p-lg-5 pt-lg-3">
              <p class="lead mx-5">
                Added a new interactive visualization mode for sorting
                algorithms, allowing players to visually understand the
                step-by-step process of popular sorting techniques like bubble
        ...
        <div className="container my-5 border-top">
          ...
          <br></br>
          <h1
            className="display-5 fw-bold lh-1 mb-3 text-center"
            style={{ color: "white" }}
          >
            Reviews
          </h1>
